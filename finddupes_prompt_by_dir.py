...
def remove_a_file(path0, path1, userinput, dryrun):
                    ...
                    if file_hash in hashes:
                        ...
                        if filecmp.cmp(other_file, file_path, shallow=False):
                            if (other_dir, dirpath) in known_paths:
                                ...
                                remove_a_file(other_file, file_path, choice, args.dryrun)
                                if choice == '0':
                                ...
                                remove_a_file(other_file, file_path, userinput, args.dryrun)
                                if userinput == '0':
                                    hashes[file_hash] = file_path
